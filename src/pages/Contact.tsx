                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <p className="text-gray-600">
                      440 BUILDING F, 1ST FLOOR, MOO 9, NONG PRUE SUBDISTRICT, BANG LAMUNG DISTRICT, CHONBURI PROVINCE 20150
                    </p>
                    <p className="text-gray-600">
                      <strong>TEL:</strong> <a href="tel:025724042" className="hover:text-mahathai-primary transition">02-572-4042 EXT. 8300</a><br />
                      <strong>MOBILE:</strong> <a href="tel:0899367598" className="hover:text-mahathai-primary transition">089-936-7598 (SONGSAK REEHUNG)</a><br />
                      <strong>FAX:</strong> 02-572-4042 EXT. 9993 (AUTOMATIC FAX)
                    </p>
                    <p className="text-gray-600">
                      <strong>E-MAIL:</strong> <a href="mailto:info@mahatai.org" className="hover:text-mahathai-primary transition">INFO@MAHATAI.ORG</a>
                    </p>
                    <p className="text-gray-600">
                      <strong>P.O. BOX:</strong> 11 PATTAYA CITY CHONBURI 20260
                    </p>
                  </div>
                  <div className="space-y-4">
                    <p className="text-gray-600">
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      <a 
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 border rounded-md hover:bg-gray-50 transition"
                      >
                        <div className="w-4 h-4 flex items-center justify-center bg-green-500 rounded-sm text-white text-xs font-bold">L</div>
                        <span>Line</span>
                      </a>
                      <a 
                        href="https://www.tiktok.com/@mahatai_official" 
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 border rounded-md hover:bg-gray-50 transition"
                      >
                        <div className="w-4 h-4 flex items-center justify-center bg-black rounded-sm text-white text-xs font-bold">T</div>
                        <span>TikTok</span>
                      </a>
                      <a 
                        href="https://www.youtube.com/c/%E0%B8%A3%E0%B8%B2%E0%B8%A2%E0%B8%81%E0%B8%B2%E0%B8%A31479%E0%B8%AD%E0%B8%AD%E0%B8%99%E0%B9%84%E0%B8%A5%E0%B8%99%E0%B9%8C/videos" 
