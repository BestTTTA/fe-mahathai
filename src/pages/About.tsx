          ...
          <div className="mb-12">
            <Card>
              <CardContent className="p-6">
                <h2 className="text-xl font-light-300 mb-4 text-mahatai-dark font-kanit text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                  ...
                  <div className="col-span-1 md:col-span-3">
                    <div className="text-center max-w-sm mx-auto">
                      ...
                      <h3 className="font-light-300 text-mahatai-dark font-kanit">บาทหลวง สุขุม ธนะสิงห์, C.Ss.R.</h3>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-light-300 text-mahatai-dark font-kanit">บาทหลวง ธนู กระทอง, C.Ss.R.</h3>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-light-300 text-mahatai-dark font-kanit">บาทหลวง วิบูลย์ ลิมปนวุฒิ, C.Ss.R.</h3>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-light-300 text-mahatai-dark font-kanit">บาทหลวง ก่อเกียรติ ดีศรี, C.Ss.R.</h3>
                    <p className="text-gray-600">กรรมการ</p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-light-300 text-mahatai-dark font-kanit">บาทหลวง อภิสิทธิ์ กฤษราลัมณ์, C.Ss.R.</h3>
                    <p className="text-gray-600">กรรมการ</p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-light-300 text-mahatai-dark font-kanit">ซิสเตอร์ ภาวิณี พิชัยศรีสวัสดิ์, IJ</h3>
                    <p className="text-gray-600">กรรมการ</p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-light-300 text-mahatai-dark font-kanit">ดร.สุภรธรรม มงคลสวัสดิ์</h3>
              ...
              <CardContent className="p-6">
                <div className="flex flex-col md:flex-row items-center gap-8">
                  ...
                  <div className="md:w-2/3">
                    <h2 className="text-xl font-light-300 mb-4 text-mahatai-dark font-kanit">
