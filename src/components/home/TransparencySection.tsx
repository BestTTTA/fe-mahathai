...
const features = [
  {
    icon: <ShieldCheck className="h-12 w-12 text-mahatai-primary" />,
  ...
  {
    icon: <BarChart className="h-12 w-12 text-mahatai-primary" />,
    title: "รายงานผลกระทบ",
...
const TransparencySection = () => {
  return (
    <section className="py-16 bg-mahatai-light">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            mahatai-X มุ่งมั่นในการรักษามาตรฐานสูงสุดด้านความโปร่งใสและการตรวจสอบได้ เพื่อให้คุณมั่นใจในการบริจาค
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <Link 
            to="/verification" 
            className="inline-flex items-center text-mahatai-primary hover:text-mahatai-secondary font-light-300"
          >
